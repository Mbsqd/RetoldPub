...
namespace retold_server.api.Contracts.BlockContracts.ScheduleContracts
{
    public class AddScheduleRequest
    {
        ...
        [MaxLength(Schedule.MAX_FIELD_LENGTH, ErrorMessage = "Title cannot be longer than " + "64" + " characters")]
        public string Title { get; set; } = string.Empty;

        [Required(ErrorMessage = "Lesson type is required")]
        [MaxLength(Schedule.MAX_FIELD_LENGTH, ErrorMessage = "Lesson type cannot be longer than " + "64" + " characters")]
        ...
        [MaxLength(Schedule.MAX_LINK_LENGTH, ErrorMessage = "First link cannot be longer than " + "256" + " characters")]
        public string LinkFirst { get; set; } = string.Empty;
        [MaxLength(Schedule.MAX_LINK_LENGTH, ErrorMessage = "Second link cannot be longer than " + "256" + " characters")]
